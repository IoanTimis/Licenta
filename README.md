...
1. **For Lecturers:**
   ...
   - They have access to a filtered list of requests from students, allowing efficient management of submissions based on various criteria such as accepted, rejected or pending requests.
